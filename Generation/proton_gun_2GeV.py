...
p.termLogLevel = 0
p.logFrequency = 1000
p.outputFiles = [ 'gun_proton_%.2f-GeV_20k_target_events_r%04d_b%d_104.root'%(myGun.energy,p.run,args.batch_job) ]
